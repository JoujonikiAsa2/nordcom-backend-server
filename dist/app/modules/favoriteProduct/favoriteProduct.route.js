...
router.get("/", (0, authGurd_1.default)(client_1.UserRole.ADMIN), favoriteProduct_controller_1.FavoriteProductControllers.GetFavoriteProducts);
...
router.delete("/delete/:id", (0, authGurd_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.CUSTOMER), favoriteProduct_controller_1.FavoriteProductControllers.DeleteFavoriteProduct);
router.get("/:userId", (0, authGurd_1.default)(client_1.UserRole.CUSTOMER), favoriteProduct_controller_1.FavoriteProductControllers.GetFavoriteProductByUserId);

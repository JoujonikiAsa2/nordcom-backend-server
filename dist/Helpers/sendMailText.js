...
exports.paymentVerificationEmailText = paymentVerificationEmailText;
const forgotPasswordEmailText = ({ name, email, token, expiresIn, }) => {
    const resetLink = `${config_1.default.client_url}/reset-password?token=${token}&email=${email}`;
    return `
...
exports.forgotPasswordEmailText = forgotPasswordEmailText;
